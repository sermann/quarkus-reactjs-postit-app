...
2. Start the workspace: [![Contribute](factory-contribute.svg)](https://codeready-openshift-workspaces.apps.cluster-8bf8.8bf8.sandbox956.opentlc.com/factory?url=https://github.com/redhat-developer-demos/quarkus-reactjs-postit-app)

The URL should use your instance of Che/CodeReady Workspaces:

```
https://<your-codeready-workspaces-instance>/factory?url=https://codeready-openshift-workspaces.apps.cluster-8bf8.8bf8.sandbox956.opentlc.com/quarkus-reactjs-postit-app
```
